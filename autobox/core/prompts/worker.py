...
def prompt(task: str, backstory: str, role: str):
    return f"""
<objective>
...
3. Your role: ${role}
4. Your previous messages for previous instructions. When the process to solve the task starts, this value is empty.
5. Instruction for this iteration.
</input>
